...
// ReadFromStart will set the tailer.File to read from the start of the file instead of its
...
//
// Heads up, this is still buggy in terms of tests. I haven't seen any real world issues, but ymmv
